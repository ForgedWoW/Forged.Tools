...
namespace Spell_Editor
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            _iconFolder = Settings.Default.IconDir.Replace("{FullSpellEditorPath}", System.Reflection.Assembly.GetEntryAssembly().Location.Replace("Spell-Editor.dll", ""));
            ...
            foreach (SpellEffectInfo eff in CurrentSpell.SpellInfo.GetEffects())
            {
                ...
                foreach (Control c in tab.Controls)
                {
                    ...
                    switch (c.Tag)
                    {
                        ...
                        // numeric
                        case "BasePoints":
                            ((NumericUpDown)c).Value = eff.BasePoints;
                            break;
                        case "AuraTickRate":
        ...
        private void btnCurIconUndo_Click(object sender, EventArgs e)
        {
            ...
            {
                var iconRecord = DataAccess.SpellIconStorage[CurrentSpell.SpellInfo.IconFileDataId];
        ...
        private void btnActiveIconUndo_Click(object sender, EventArgs e)
        {
            ...
            {
                var iconRecord = DataAccess.SpellIconStorage[CurrentSpell.SpellInfo.ActiveIconFileDataId];
