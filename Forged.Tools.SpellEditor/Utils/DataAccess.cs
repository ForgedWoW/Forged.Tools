...
namespace Forged.Tools.SpellEditor.Utils
{
    public class DataAccess : BaseDataAccess
    {
        ...
        public void LoadStores()
        {
            ...
            CliDB.BattlePetSpeciesStorage = CliDB.ReadDB2<BattlePetSpeciesRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "BattlePetSpecies.db2", HotfixStatements.SEL_BATTLE_PET_SPECIES, HotfixStatements.SEL_BATTLE_PET_SPECIES_LOCALE);
            CliDB.DifficultyStorage = CliDB.ReadDB2<DifficultyRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "Difficulty.db2", HotfixStatements.SEL_DIFFICULTY, HotfixStatements.SEL_DIFFICULTY_LOCALE);
            ...
            CliDB.SpellAuraOptionsStorage = CliDB.ReadDB2<SpellAuraOptionsRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellAuraOptions.db2", HotfixStatements.SEL_SPELL_AURA_OPTIONS);
            CliDB.SpellAuraRestrictionsStorage = CliDB.ReadDB2<SpellAuraRestrictionsRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellAuraRestrictions.db2", HotfixStatements.SEL_SPELL_AURA_RESTRICTIONS);
            CliDB.SpellCastTimesStorage = CliDB.ReadDB2<SpellCastTimesRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellCastTimes.db2", HotfixStatements.SEL_SPELL_CAST_TIMES);
            CliDB.SpellCastingRequirementsStorage = CliDB.ReadDB2<SpellCastingRequirementsRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellCastingRequirements.db2", HotfixStatements.SEL_SPELL_CASTING_REQUIREMENTS);
            CliDB.SpellCategoriesStorage = CliDB.ReadDB2<SpellCategoriesRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellCategories.db2", HotfixStatements.SEL_SPELL_CATEGORIES);
            CliDB.SpellCategoryStorage = CliDB.ReadDB2<SpellCategoryRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellCategory.db2", HotfixStatements.SEL_SPELL_CATEGORY, HotfixStatements.SEL_SPELL_CATEGORY_LOCALE);
            CliDB.SpellClassOptionsStorage = CliDB.ReadDB2<SpellClassOptionsRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellClassOptions.db2", HotfixStatements.SEL_SPELL_CLASS_OPTIONS);
            CliDB.SpellCooldownsStorage = CliDB.ReadDB2<SpellCooldownsRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellCooldowns.db2", HotfixStatements.SEL_SPELL_COOLDOWNS);
            CliDB.SpellDurationStorage = CliDB.ReadDB2<SpellDurationRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellDuration.db2", HotfixStatements.SEL_SPELL_DURATION);
            CliDB.SpellEffectStorage = CliDB.ReadDB2<SpellEffectRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellEffect.db2", HotfixStatements.SEL_SPELL_EFFECT);
            CliDB.SpellEquippedItemsStorage = CliDB.ReadDB2<SpellEquippedItemsRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellEquippedItems.db2", HotfixStatements.SEL_SPELL_EQUIPPED_ITEMS);
            CliDB.SpellFocusObjectStorage = CliDB.ReadDB2<SpellFocusObjectRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellFocusObject.db2", HotfixStatements.SEL_SPELL_FOCUS_OBJECT, HotfixStatements.SEL_SPELL_FOCUS_OBJECT_LOCALE);
            CliDB.SpellInterruptsStorage = CliDB.ReadDB2<SpellInterruptsRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellInterrupts.db2", HotfixStatements.SEL_SPELL_INTERRUPTS);
            CliDB.SpellItemEnchantmentStorage = CliDB.ReadDB2<SpellItemEnchantmentRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellItemEnchantment.db2", HotfixStatements.SEL_SPELL_ITEM_ENCHANTMENT, HotfixStatements.SEL_SPELL_ITEM_ENCHANTMENT_LOCALE);
            CliDB.SpellItemEnchantmentConditionStorage = CliDB.ReadDB2<SpellItemEnchantmentConditionRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellItemEnchantmentCondition.db2", HotfixStatements.SEL_SPELL_ITEM_ENCHANTMENT_CONDITION);
            CliDB.SpellLabelStorage = CliDB.ReadDB2<SpellLabelRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellLabel.db2", HotfixStatements.SEL_SPELL_LABEL);
            CliDB.SpellLearnSpellStorage = CliDB.ReadDB2<SpellLearnSpellRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellLearnSpell.db2", HotfixStatements.SEL_SPELL_LEARN_SPELL);
            CliDB.SpellLevelsStorage = CliDB.ReadDB2<SpellLevelsRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellLevels.db2", HotfixStatements.SEL_SPELL_LEVELS);
            CliDB.SpellMiscStorage = CliDB.ReadDB2<SpellMiscRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellMisc.db2", HotfixStatements.SEL_SPELL_MISC);
            CliDB.SpellPowerStorage = CliDB.ReadDB2<SpellPowerRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellPower.db2", HotfixStatements.SEL_SPELL_POWER);
            CliDB.SpellPowerDifficultyStorage = CliDB.ReadDB2<SpellPowerDifficultyRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellPowerDifficulty.db2", HotfixStatements.SEL_SPELL_POWER_DIFFICULTY);
            CliDB.SpellProcsPerMinuteStorage = CliDB.ReadDB2<SpellProcsPerMinuteRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellProcsPerMinute.db2", HotfixStatements.SEL_SPELL_PROCS_PER_MINUTE);
            CliDB.SpellProcsPerMinuteModStorage = CliDB.ReadDB2<SpellProcsPerMinuteModRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellProcsPerMinuteMod.db2", HotfixStatements.SEL_SPELL_PROCS_PER_MINUTE_MOD);
            CliDB.SpellRadiusStorage = CliDB.ReadDB2<SpellRadiusRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellRadius.db2", HotfixStatements.SEL_SPELL_RADIUS);
            CliDB.SpellRadiusStorage.Add(0, new SpellRadiusRecord() { Id = 0, Radius = 0, RadiusMin = 0, RadiusMax = 0, RadiusPerLevel = 0 });
            CliDB.SpellRangeStorage = CliDB.ReadDB2<SpellRangeRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellRange.db2", HotfixStatements.SEL_SPELL_RANGE, HotfixStatements.SEL_SPELL_RANGE_LOCALE);
            CliDB.SpellReagentsStorage = CliDB.ReadDB2<SpellReagentsRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellReagents.db2", HotfixStatements.SEL_SPELL_REAGENTS);
            CliDB.SpellReagentsCurrencyStorage = CliDB.ReadDB2<SpellReagentsCurrencyRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellReagentsCurrency.db2", HotfixStatements.SEL_SPELL_REAGENTS_CURRENCY);
            CliDB.SpellScalingStorage = CliDB.ReadDB2<SpellScalingRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellScaling.db2", HotfixStatements.SEL_SPELL_SCALING);
            CliDB.SpellShapeshiftStorage = CliDB.ReadDB2<SpellShapeshiftRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellShapeshift.db2", HotfixStatements.SEL_SPELL_SHAPESHIFT);
            CliDB.SpellShapeshiftFormStorage = CliDB.ReadDB2<SpellShapeshiftFormRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellShapeshiftForm.db2", HotfixStatements.SEL_SPELL_SHAPESHIFT_FORM, HotfixStatements.SEL_SPELL_SHAPESHIFT_FORM_LOCALE);
            CliDB.SpellTargetRestrictionsStorage = CliDB.ReadDB2<SpellTargetRestrictionsRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellTargetRestrictions.db2", HotfixStatements.SEL_SPELL_TARGET_RESTRICTIONS);
            CliDB.SpellTotemsStorage = CliDB.ReadDB2<SpellTotemsRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellTotems.db2", HotfixStatements.SEL_SPELL_TOTEMS);
            CliDB.SpellVisualStorage = CliDB.ReadDB2<SpellVisualRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellVisual.db2", HotfixStatements.SEL_SPELL_VISUAL);
            CliDB.SpellVisualEffectNameStorage = CliDB.ReadDB2<SpellVisualEffectNameRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellVisualEffectName.db2", HotfixStatements.SEL_SPELL_VISUAL_EFFECT_NAME);
            CliDB.SpellVisualMissileStorage = CliDB.ReadDB2<SpellVisualMissileRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellVisualMissile.db2", HotfixStatements.SEL_SPELL_VISUAL_MISSILE);
            CliDB.SpellVisualKitStorage = CliDB.ReadDB2<SpellVisualKitRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellVisualKit.db2", HotfixStatements.SEL_SPELL_VISUAL_KIT);
            CliDB.SpellXSpellVisualStorage = CliDB.ReadDB2<SpellXSpellVisualRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellXSpellVisual.db2", HotfixStatements.SEL_SPELL_X_SPELL_VISUAL);
            CliDB.SummonPropertiesStorage = CliDB.ReadDB2<SummonPropertiesRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SummonProperties.db2", HotfixStatements.SEL_SUMMON_PROPERTIES);
            CliDB.TotemCategoryStorage = CliDB.ReadDB2<TotemCategoryRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "TotemCategory.db2", HotfixStatements.SEL_TOTEM_CATEGORY, HotfixStatements.SEL_TOTEM_CATEGORY_LOCALE);
            CliDB.CurrencyTypesStorage = CliDB.ReadDB2<CurrencyTypesRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "CurrencyTypes.db2", HotfixStatements.SEL_CURRENCY_TYPES, HotfixStatements.SEL_CURRENCY_TYPES_LOCALE);
            CliDB.SpellEmpowerStorage = CliDB.ReadDB2<SpellEmpowerRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellEmpower.db2", HotfixStatements.SEL_SPELL_EMPOWER);
            CliDB.SpellEmpowerStageStorage = CliDB.ReadDB2<SpellEmpowerStageRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellEmpowerStage.db2", HotfixStatements.SEL_SPELL_EMPOWER_STAGE);
            CliDB.SpellReplacementStorage = CliDB.ReadDB2<SpellReplacementRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "SpellReplacement.db2", HotfixStatements.SEL_SPELL_REPLACEMENT);

            CliDB.SpellStorage = CliDB.ReadDB2<SpellRecord>(_availableDb2Locales, _db2Path, Locale.enUS, "Spell.db2", HotfixStatements.SEL_SPELL);
