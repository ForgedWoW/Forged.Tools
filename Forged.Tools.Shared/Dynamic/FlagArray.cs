...
namespace Forged.Tools.Shared.Dynamic
{
    ...
    public class FlagArray128 : FlagsArray<uint>
    {
        ...
        {
            return ((_storage[0] & parts[0]) != 0 || (_storage[1] & parts[1]) != 0 || (_storage[2] & parts[2]) != 0 || (_storage[3] & parts[3]) != 0);
        }

        public bool HasFlag(FlagArray128 other)
        {
            return ((_storage[0] & other[0]) != 0 || (_storage[1] & other[1]) != 0 || (_storage[2] & other[2]) != 0 || (_storage[3] & other[3]) != 0);
        }

        public bool Match(FlagArray128 other)
        {
            return ((_storage[0] & other[0]) != 0 && (_storage[1] & other[1]) != 0 && (_storage[2] & other[2]) != 0 && (_storage[3] & other[3]) != 0);
        }
