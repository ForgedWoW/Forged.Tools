...
namespace Game.Entities
{
    ...
    public class UnitData : BaseUpdateData<Unit>
    {
        ...
        public UpdateFieldArray<int> Stats = new((uint)CharacterStats.Max, 159, 160);
        public UpdateFieldArray<int> StatPosBuff = new((uint)CharacterStats.Max, 159, 164);
        public UpdateFieldArray<int> StatNegBuff = new((uint)CharacterStats.Max, 159, 168);
