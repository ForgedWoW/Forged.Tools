...
namespace Game.Entities
{
    public partial class Unit
    {
        ...
        protected float[] CreateStats = new float[(int)CharacterStats.Max];
        float[] m_floatStatPosBuff = new float[(int)CharacterStats.Max];
        float[] m_floatStatNegBuff = new float[(int)CharacterStats.Max];
