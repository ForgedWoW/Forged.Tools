...
{
    class CommerceTokenGetCountResponse : ServerPacket
    {
        public CommerceTokenGetCountResponse() : base(ServerOpcodes.CommerceTokenGetCountResponse) { }
        ...
        public uint Count; // preset auction duration enum
    }
