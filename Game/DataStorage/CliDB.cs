...
namespace Game.DataStorage
{
    public class CliDB
    {
        ...
        public static void LoadGameTables(string dataPath)
        {
            ...
            HPRegenPerSpiritTable = ReadGameTable<GtRegenHPPerSptEntry>("HPRegenPerSpirit.txt");
            MPRegenPerSpiritTable = ReadGameTable<GtRegenMPPerSptEntry>("MPRegenPerSpirit.txt");
            RatioCombatRatingsTable = ReadGameTable<GtCombatRatingsEntry>("RatioCombatRatings.txt");
            BaseMeleeCritChanceTable = ReadGameTable<GtChanceToMeleeCritBaseEntry>("BaseMeleeCritChance.txt");
            MeleeCritChanceTable = ReadGameTable<GtChanceToMeleeCritEntry>("MeleeCritChance.txt");
            BaseSpellCritChanceTable = ReadGameTable<GtChanceToSpellCritBaseEntry>("BaseSpellCritChance.txt");
            SpellCritChanceTable = ReadGameTable<GtChanceToSpellCritEntry>("SpellCritChance.txt");
            OCTClassCombatRatingScalarTable = ReadGameTable<GtOCTClassCombatRatingScalarEntry>("OCTClassCombatRatingScalar.txt");
            OCTRegenHPTable = ReadGameTable<GtOCTRegenHPEntry>("OCTRegenHP.txt");
