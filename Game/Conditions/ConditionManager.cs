...
namespace Game
{
    public sealed class ConditionManager : Singleton<ConditionManager>
    {
        ...
        public void LoadConditions(bool isReload = false)
        {
            ...
            do
            {
                ...
                if (iConditionTypeOrReference < 0)//it has a reference
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "Condition reference {1} is referencing self, skipped", iSourceTypeOrReferenceId);
                        continue;
                    }
                    ...
                    if (cond.ConditionTarget != 0)
                        Log.outWarn(LogFilter.Sql, "Condition {0} {1} has useless data in ConditionTarget ({2})!", rowType, iSourceTypeOrReferenceId, cond.ConditionTarget);
                    if (cond.ConditionValue1 != 0)
                        Log.outWarn(LogFilter.Sql, "Condition {0} {1} has useless data in value1 ({2})!", rowType, iSourceTypeOrReferenceId, cond.ConditionValue1);
                    if (cond.ConditionValue2 != 0)
                        Log.outWarn(LogFilter.Sql, "Condition {0} {1} has useless data in value2 ({2})!", rowType, iSourceTypeOrReferenceId, cond.ConditionValue2);
                    if (cond.ConditionValue3 != 0)
                        Log.outWarn(LogFilter.Sql, "Condition {0} {1} has useless data in value3 ({2})!", rowType, iSourceTypeOrReferenceId, cond.ConditionValue3);
                    if (cond.NegativeCondition)
                        Log.outWarn(LogFilter.Sql, "Condition {0} {1} has useless data in NegativeCondition ({2})!", rowType, iSourceTypeOrReferenceId, cond.NegativeCondition);
                    if (cond.SourceGroup != 0 && iSourceTypeOrReferenceId < 0)
                        Log.outWarn(LogFilter.Sql, "Condition {0} {1} has useless data in SourceGroup ({2})!", rowType, iSourceTypeOrReferenceId, cond.SourceGroup);
                    if (cond.SourceEntry != 0 && iSourceTypeOrReferenceId < 0)
                        Log.outWarn(LogFilter.Sql, "Condition {0} {1} has useless data in SourceEntry ({2})!", rowType, iSourceTypeOrReferenceId, cond.SourceEntry);
                }
                ...
                {
                    Log.outWarn(LogFilter.Sql, "{0} has not allowed value of SourceGroup = {1}!", cond.ToString(), cond.SourceGroup);
                    continue;
                }
                if (cond.SourceId != 0 && !CanHaveSourceIdSet(cond.SourceType))
                {
                    Log.outWarn(LogFilter.Sql, "{0} has not allowed value of SourceId = {1}!", cond.ToString(), cond.SourceId);
                    continue;
                }

                if (cond.ErrorType != 0 && cond.SourceType != ConditionSourceType.Spell)
                {
                    Log.outWarn(LogFilter.Sql, "{0} can't have ErrorType ({1}), set to 0!", cond.ToString(), cond.ErrorType);
                    cond.ErrorType = 0;
                }

                if (cond.ErrorTextId != 0 && cond.ErrorType == 0)
                {
                    Log.outWarn(LogFilter.Sql, "{0} has any ErrorType, ErrorTextId ({1}) is set, set to 0!", cond.ToString(), cond.ErrorTextId);
                    cond.ErrorTextId = 0;
                }
                ...
                if (cond.SourceGroup != 0)
                {
                    ...
                    if (!valid)
                        Log.outWarn(LogFilter.Sql, "{0} Not handled grouped condition.", cond.ToString());
                    else
                        ++count;
        ...
        bool AddToLootTemplate(Condition cond, LootTemplate loot)
        {
            if (loot == null)
            {
                Log.outWarn(LogFilter.Sql, "{0} LootTemplate {1} not found.", cond.ToString(), cond.SourceGroup);
                return false;
            }
            ...
            Log.outWarn(LogFilter.Sql, "{0} Item {1} not found in LootTemplate {2}.", cond.ToString(), cond.SourceEntry, cond.SourceGroup);
            return false;
        }
        ...
        bool AddToGossipMenus(Condition cond)
        {
            ...
            Log.outWarn(LogFilter.Sql, "{0} GossipMenu {1} not found.", cond.ToString(), cond.SourceGroup);
            return false;
        }
        ...
        bool AddToGossipMenuItems(Condition cond)
        {
            ...
            Log.outWarn(LogFilter.Sql, "{0} GossipMenuId {1} Item {2} not found.", cond.ToString(), cond.SourceGroup, cond.SourceEntry);
            return false;
        }
                    ...
                    if ((conditionEffMask & (1 << (int)spellEffectInfo.EffectIndex)) != 0)
                    {
                        switch (cond.ConditionType)
                        {
                            case ConditionTypes.ObjectEntryGuid:
                            {
                                ...
                                {
                                    Log.outWarn(LogFilter.Sql, $"{cond} in `condition` table - spell {spellInfo.Id} EFFECT_{spellEffectInfo.EffectIndex} - target requires ConditionValue1 to be either TYPEID_UNIT ({(uint)TypeId.Unit}) or TYPEID_PLAYER ({(uint)TypeId.Player})");
                                    return;
                                }

                                if (implicitTargetMask.HasFlag(SpellCastTargetFlags.GameobjectMask) && cond.ConditionValue1 != (uint)TypeId.GameObject)
                                {
                                    Log.outWarn(LogFilter.Sql, $"{cond} in `condition` table - spell {spellInfo.Id} EFFECT_{spellEffectInfo.EffectIndex} - target requires ConditionValue1 to be TYPEID_GAMEOBJECT ({(uint)TypeId.GameObject})");
                                    return;
                                }

                                if (implicitTargetMask.HasFlag(SpellCastTargetFlags.CorpseMask) && cond.ConditionValue1 != (uint)TypeId.Corpse)
                                {
                                    Log.outWarn(LogFilter.Sql, $"{cond} in `condition` table - spell {spellInfo.Id} EFFECT_{spellEffectInfo.EffectIndex} - target requires ConditionValue1 to be TYPEID_CORPSE ({(uint)TypeId.Corpse})");
                                    return;
                                }
                                break;
                            }
                ...
                foreach (var effectMask in sharedMasks)
                {
                    ...
                    if (commonMask != 0)
                    {
                        ...
                        if (sharedList != null)
                        {
                            ...
                            {
                                Log.outWarn(LogFilter.Sql, "{0} in `condition` table, has incorrect SourceGroup {1} (spell effectMask) set - " +
        ...
        bool AddToPhases(Condition cond)
        {
            ...
            Log.outWarn(LogFilter.Sql, "{0} Area {1} does not have phase {2}.", cond.ToString(), cond.SourceGroup, cond.SourceEntry);
            return false;
        }
        ...
        bool IsSourceTypeValid(Condition cond)
        {
            switch (cond.SourceType)
            {
                case ConditionSourceType.CreatureLootTemplate:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceGroup in `condition` table, does not exist in `creature_loot_template`, ignoring.", cond.ToString());
                        return false;
                    }
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceType, SourceEntry in `condition` table, Item does not exist, ignoring.", cond.ToString());
                        return false;
                    }
                    break;
                }
                case ConditionSourceType.DisenchantLootTemplate:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceGroup in `condition` table, does not exist in `disenchant_loot_template`, ignoring.", cond.ToString());
                        return false;
                    }
                ...
                case ConditionSourceType.FishingLootTemplate:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceGroup in `condition` table, does not exist in `fishing_loot_template`, ignoring.", cond.ToString());
                        return false;
                    }
                ...
                case ConditionSourceType.GameobjectLootTemplate:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceGroup in `condition` table, does not exist in `gameobject_loot_template`, ignoring.", cond.ToString());
                        return false;
                    }
                ...
                case ConditionSourceType.ItemLootTemplate:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceGroup in `condition` table, does not exist in `item_loot_template`, ignoring.", cond.ToString());
                        return false;
                    }
                ...
                case ConditionSourceType.MailLootTemplate:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceGroup in `condition` table, does not exist in `mail_loot_template`, ignoring.", cond.ToString());
                        return false;
                    }
                ...
                case ConditionSourceType.MillingLootTemplate:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceGroup in `condition` table, does not exist in `milling_loot_template`, ignoring.", cond.ToString());
                        return false;
                    }
                ...
                case ConditionSourceType.PickpocketingLootTemplate:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceGroup in `condition` table, does not exist in `pickpocketing_loot_template`, ignoring.", cond.ToString());
                        return false;
                    }
                ...
                case ConditionSourceType.ProspectingLootTemplate:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceGroup in `condition` table, does not exist in `prospecting_loot_template`, ignoring.", cond.ToString());
                        return false;
                    }
                ...
                case ConditionSourceType.ReferenceLootTemplate:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceGroup in `condition` table, does not exist in `reference_loot_template`, ignoring.", cond.ToString());
                        return false;
                    }
                ...
                case ConditionSourceType.SkinningLootTemplate:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceGroup in `condition` table, does not exist in `skinning_loot_template`, ignoring.", cond.ToString());
                        return false;
                    }
                ...
                case ConditionSourceType.SpellLootTemplate:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceGroup in `condition` table, does not exist in `spell_loot_template`, ignoring.", cond.ToString());
                        return false;
                    }
                ...
                case ConditionSourceType.SpellImplicitTarget:
                {
                    ...
                    if (spellInfo == null)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceEntry in `condition` table does not exist in `spell.db2`, ignoring.", cond.ToString());
                        return false;
                    }

                    if ((cond.SourceGroup > SpellConst.MaxEffectMask) || cond.SourceGroup == 0)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} in `condition` table, has incorrect SourceGroup (spell effectMask) set, ignoring.", cond.ToString());
                        return false;
                    }
                    ...
                    foreach (SpellEffectInfo spellEffectInfo in spellInfo.GetEffects())
                    {
                        ...
                        Log.outWarn(LogFilter.Sql, "SourceEntry {0} SourceGroup {1} in `condition` table - spell {2} does not have implicit targets of types: _AREA_, _CONE_, _NEARBY_, _CHAIN_ for effect {3}, SourceGroup needs correction, ignoring.", cond.SourceEntry, origGroup, cond.SourceEntry, spellEffectInfo.EffectIndex);
                ...
                case ConditionSourceType.CreatureTemplateVehicle:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceEntry in `condition` table does not exist in `creature_template`, ignoring.", cond.ToString());
                        return false;
                    }
                    break;
                }
                ...
                case ConditionSourceType.QuestAvailable:
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceEntry specifies non-existing quest, skipped.", cond.ToString());
                        return false;
                    }
                    break;
                case ConditionSourceType.VehicleSpell:
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceGroup in `condition` table does not exist in `creature_template`, ignoring.", cond.ToString());
                        return false;
                    }
                ...
                case ConditionSourceType.NpcVendor:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceEntry in `condition` table item does not exist, ignoring.", cond.ToString());
                        return false;
                    }
                    break;
                }
                case ConditionSourceType.TerrainSwap:
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceEntry in `condition` table does not exist in Map.db2, ignoring.", cond.ToString());
                        return false;
                    }
                    break;
                case ConditionSourceType.Phase:
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} SourceEntry in `condition` table does not exist in AreaTable.db2, ignoring.", cond.ToString());
                        return false;
                    }
                    break;
                case ConditionSourceType.GossipMenu:
                ...
                case ConditionSourceType.Graveyard:
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString()} SourceEntry in `condition` table, does not exist in WorldSafeLocs.db2, ignoring.");
                        return false;
                    }
                    break;
                case ConditionSourceType.AreaTrigger:
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString()} in `condition` table, unexpected SourceEntry value (expected 0 or 1), ignoring.");
                        return false;
                    }
                    if (Global.AreaTriggerDataStorage.GetAreaTriggerTemplate(new AreaTriggerId(cond.SourceGroup, cond.SourceEntry != 0)) == null)
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString()} in `condition` table, does not exist in `areatrigger_template`, ignoring.");
                        return false;
                    }
                    break;
                case ConditionSourceType.ConversationLine:
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond} does not exist in `conversation_line_template`, ignoring.");
                        return false;
                    }
                    break;
                case ConditionSourceType.AreatriggerClientTriggered:
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond} SourceEntry in `condition` table, does not exists in AreaTrigger.db2, ignoring.");
                        return false;
                    }
                    break;
                case ConditionSourceType.TrainerSpell:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString()} SourceGroup in `condition` table, does not exist in `trainer`, ignoring.");
                        return false;
                    }
                    if (Global.SpellMgr.GetSpellInfo((uint)cond.SourceEntry, Difficulty.None) == null)
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString()} SourceEntry in `condition` table does not exist in `Spell.db2`, ignoring.");
                        return false;
                    }
                    break;
                }
                case ConditionSourceType.ObjectIdVisibility:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString()} SourceGroup in `condition` table, is no valid object type, ignoring.");
                        return false;
                    }
                    ...
                    if (cond.SourceGroup == (uint)TypeId.Unit)
                    {
                        if (Global.ObjectMgr.GetCreatureTemplate((uint)cond.SourceEntry) == null)
                        {
                            Log.outWarn(LogFilter.Sql, $"{cond.ToString()} SourceEntry in `condition` table, does not exist in `creature_template`, ignoring.");
                            return false;
                        }
                    }
                    else if (cond.SourceGroup == (uint)TypeId.GameObject)
                    {
                        ...
                        {
                            Log.outWarn(LogFilter.Sql, $"{cond.ToString()} SourceEntry in `condition` table, does not exist in `gameobject_template`, ignoring.");
                            return false;
                        }
                    }
                    else
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString()} SourceGroup in `condition` table, uses unchecked type id, ignoring.");
                        return false;
                    }
                    break;
                }
                case ConditionSourceType.SpawnGroup:
                {
                    ...
                    if (spawnGroup == null)
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString()} SourceEntry in `condition` table, does not exist in `spawn_group_template`, ignoring.");
                        return false;
                    }
                    if (spawnGroup.flags.HasAnyFlag(SpawnGroupFlags.System | SpawnGroupFlags.ManualSpawn))
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString()} in `spawn_group_template` table cannot have SPAWNGROUP_FLAG_SYSTEM or SPAWNGROUP_FLAG_MANUAL_SPAWN flags, ignoring.");
                        return false;
                    }
                    break;
                }
                default:
                    Log.outWarn(LogFilter.Sql, $"{cond.ToString()} Invalid ConditionSourceType in `condition` table, ignoring.");
                    return false;
            }
        ...
        bool IsConditionTypeValid(Condition cond)
        {
            switch (cond.ConditionType)
            {
                case ConditionTypes.Aura:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing spell (Id: {1}), skipped", cond.ToString(), cond.ConditionValue1);
                        return false;
                    }

                    if (cond.ConditionValue2 >= SpellConst.MaxEffects)
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString(true)} has non existing effect index ({cond.ConditionValue2}) (must be 0..{SpellConst.MaxEffects - 1}), skipped");
                        return false;
                    }
                    break;
                }
                case ConditionTypes.Item:
                {
                    ...
                    if (proto == null)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} Item ({1}) does not exist, skipped", cond.ToString(), cond.ConditionValue1);
                        return false;
                    }

                    if (cond.ConditionValue2 == 0)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} Zero item count in ConditionValue2, skipped", cond.ToString());
                        return false;
                    }
                    break;
                }
                case ConditionTypes.ItemEquipped:
                {
                    ...
                    if (proto == null)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} Item ({1}) does not exist, skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.Zoneid:
                {
                    ...
                    if (areaEntry == null)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} Area ({1}) does not exist, skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }

                    if (areaEntry.ParentAreaID != 0)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} requires to be in area ({1}) which is a subzone but zone expected, skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.ReputationRank:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing faction ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.Team:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} specifies unknown team ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.Skill:
                {
                    ...
                    if (pSkill == null)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} specifies non-existing skill ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }

                    if (cond.ConditionValue2 < 1 || cond.ConditionValue2 > Global.WorldMgr.GetConfigMaxSkillValue())
                    {
                        Log.outWarn(LogFilter.Sql, "{0} specifies skill ({1}) with invalid value ({1}), skipped.", cond.ToString(true), cond.ConditionValue1, cond.ConditionValue2);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.Queststate:
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has invalid state mask ({1}), skipped.", cond.ToString(true), cond.ConditionValue2);
                        return false;
                    }

                    if (Global.ObjectMgr.GetQuestTemplate(cond.ConditionValue1) == null)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} points to non-existing quest ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                ...
                case ConditionTypes.ActiveEvent:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing event id ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.Achievement:
                {
                    ...
                    if (achievement == null)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing achivement id ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.Class:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing classmask ({1}), skipped.", cond.ToString(true), cond.ConditionValue1 & ~(uint)Class.ClassMaskAllPlayable);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.Race:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing racemask ({1}), skipped.", cond.ToString(true), cond.ConditionValue1 & ~SharedConst.RaceMaskAllPlayable);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.Gender:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has invalid gender ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.Mapid:
                {
                    ...
                    if (me == null)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing map ({1}), skipped", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.Spell:
                {
                    if (!Global.SpellMgr.HasSpellInfo(cond.ConditionValue1, Difficulty.None))
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing spell (Id: {1}), skipped", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.Level:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has invalid ComparisionType ({1}), skipped.", cond.ToString(true), cond.ConditionValue2);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.DrunkenState:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has invalid state ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.NearCreature:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing creature template entry ({1}), skipped", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.NearGameobject:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing gameobject template entry ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.ObjectEntryGuid:
                {
                    switch ((TypeId)cond.ConditionValue1)
                    {
                        case TypeId.Unit:
                            ...
                            {
                                Log.outWarn(LogFilter.Sql, "{0} has non existing creature template entry ({1}), skipped.", cond.ToString(true), cond.ConditionValue2);
                                return false;
                            }
                            if (cond.ConditionValue3 != 0)
                            {
                                ...
                                if (creatureData != null)
                                {
                                    ...
                                    {
                                        Log.outWarn(LogFilter.Sql, "{0} has guid {1} set but does not match creature entry ({1}), skipped.", cond.ToString(true), cond.ConditionValue3, cond.ConditionValue2);
                                        return false;
                                    }
                                }
                                else
                                {
                                    Log.outWarn(LogFilter.Sql, "{0} has non existing creature guid ({1}), skipped.", cond.ToString(true), cond.ConditionValue3);
                                    return false;
                                }
                            }
                            break;
                        case TypeId.GameObject:
                            ...
                            {
                                Log.outWarn(LogFilter.Sql, "{0} has non existing gameobject template entry ({1}), skipped.", cond.ToString(true), cond.ConditionValue2);
                                return false;
                            }
                            if (cond.ConditionValue3 != 0)
                            {
                                ...
                                if (goData != null)
                                {
                                    ...
                                    {
                                        Log.outWarn(LogFilter.Sql, "{0} has guid {1} set but does not match gameobject entry ({1}), skipped.", cond.ToString(true), cond.ConditionValue3, cond.ConditionValue2);
                                        return false;
                                    }
                                }
                                else
                                {
                                    Log.outWarn(LogFilter.Sql, "{0} has non existing gameobject guid ({1}), skipped.", cond.ToString(true), cond.ConditionValue3);
                                    return false;
                                }
                            }
                            break;
                        ...
                        case TypeId.Corpse:
                            ...
                            break;
                        default:
                            Log.outWarn(LogFilter.Sql, "{0} has wrong typeid set ({1}), skipped", cond.ToString(true), cond.ConditionValue1);
                            return false;
                    }
                    break;
                }
                case ConditionTypes.TypeMask:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has invalid typemask set ({1}), skipped.", cond.ToString(true), cond.ConditionValue2);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.RelationTo:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has invalid ConditionValue1(ConditionTarget selection) ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    if (cond.ConditionValue1 == cond.ConditionTarget)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has ConditionValue1(ConditionTarget selection) set to self ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    if (cond.ConditionValue2 >= (uint)RelationType.Max)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has invalid ConditionValue2(RelationType) ({1}), skipped.", cond.ToString(true), cond.ConditionValue2);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.ReactionTo:
                {
                    ...
                    if (cond.ConditionValue2 == 0)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has invalid ConditionValue2(rankMask) ({1}), skipped.", cond.ToString(true), cond.ConditionValue2);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.DistanceTo:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has invalid ComparisionType ({1}), skipped.", cond.ToString(true), cond.ConditionValue3);
                        return false;
                    }
                    break;
                }
                ...
                case ConditionTypes.HpPct:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has too big percent value ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    if (cond.ConditionValue2 >= (uint)ComparisionType.Max)
                    {
                ...
                case ConditionTypes.WorldState:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing world state in value1 ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.PhaseId:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has nonexistent phaseid in value1 ({1}), skipped", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.Title:
                {
                    ...
                    if (titleEntry == null)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing title in value1 ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                ...
                {
                    Log.outWarn(LogFilter.Sql, $"{cond.ToString(true)} using deprecated condition type CONDITION_SPAWNMASK.");
                    return false;
                }
                case ConditionTypes.UnitState:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing UnitState in value1 ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.CreatureType:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing CreatureType in value1 ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.RealmAchievement:
                {
                    ...
                    if (achievement == null)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non existing realm first achivement id ({1}), skipped.", cond.ToString(), cond.ConditionValue1);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.StandState:
                {
                    ...
                    if (!valid)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non-existing stand state ({1},{2}), skipped.", cond.ToString(true), cond.ConditionValue1, cond.ConditionValue2);
                        return false;
                    }
                    break;
                }
                case ConditionTypes.ObjectiveProgress:
                {
                    ...
                    if (obj == null)
                    {
                        Log.outWarn(LogFilter.Sql, "{0} points to non-existing quest objective ({1}), skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    int limit = obj.IsStoringFlag() ? 1 : obj.Amount;
                    if (cond.ConditionValue3 > limit)
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString(true)} has quest objective count {cond.ConditionValue3} in value3, but quest objective {cond.ConditionValue1} has a maximum objective count of {limit}, skipped.");
                        return false;
                    }
                    break;
                }
                case ConditionTypes.PetType:
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, "{0} has non-existing pet type {1}, skipped.", cond.ToString(true), cond.ConditionValue1);
                        return false;
                    }
                    break;
                ...
                case ConditionTypes.DifficultyId:
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString(true)} has non existing difficulty in value1 ({cond.ConditionValue1}), skipped.");
                        return false;
                    }
                    break;
                case ConditionTypes.BattlePetCount:
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString(true)} has non existing BattlePet SpeciesId in value1 ({cond.ConditionValue1}), skipped.");
                        return false;
                    }
                    if (cond.ConditionValue2 > SharedConst.DefaultMaxBattlePetsPerSpecies)
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString(true)} has invalid (greater than {SharedConst.DefaultMaxBattlePetsPerSpecies}) value2 ({cond.ConditionValue2}), skipped.");
                        return false;
                    }
                    if (cond.ConditionValue3 >= (uint)ComparisionType.Max)
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString(true)} has invalid ComparisionType ({cond.ConditionValue3}), skipped.");
                        return false;
                    }
                    break;
                case ConditionTypes.ScenarioStep:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString(true)} has non existing ScenarioStep in value1 ({cond.ConditionValue1}), skipped.");
                        return false;
                    }
                    break;
                }
                case ConditionTypes.SceneInProgress:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString(true)} has non existing SceneScriptPackageId in value1 ({cond.ConditionValue1}), skipped.");
                        return false;
                    }
                    break;
                }
                case ConditionTypes.PlayerCondition:
                {
                    ...
                    {
                        Log.outWarn(LogFilter.Sql, $"{cond.ToString(true)} has non existing PlayerConditionId in value1 ({cond.ConditionValue1}), skipped.");
                        return false;
                    }
                    break;
                }
                default:
                    Log.outWarn(LogFilter.Sql, $"{cond.ToString()} Invalid ConditionType in `condition` table, ignoring.");
                    return false;
            }

            if (cond.ConditionTarget >= cond.GetMaxAvailableConditionTargets())
            {
                Log.outWarn(LogFilter.Sql, $"{cond.ToString(true)} in `condition` table, has incorrect ConditionTarget set, ignoring.");
                return false;
            }
        ...
        {
            Log.outWarn(LogFilter.Sql, "{0} has useless data in ConditionValue{1} ({2})!", cond.ToString(true), index, value);
        }
